...
/* istanbul ignore next */ export function isMobileViewport(innerWidth: number, breakpoint: number = 768): boolean {
  return innerWidth < breakpoint;
}

/* istanbul ignore next */ export function isDesktopViewport(innerWidth: number, breakpoint: number = 768): boolean {
  return innerWidth >= breakpoint;
}
